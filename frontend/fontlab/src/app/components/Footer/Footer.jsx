        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p>
                Welcome to FontLabs , fuse your fav fonts , get recommendations , get a pair of fonts , connect with artists and proffessionals
              </p>
            </div>
            <div className="px-10">
              ...
              <p className="mb-4">
                <a href="/fuse" className=" text-black">
                  Font Fuse
                </a>
              </p>
              <p className="mb-4">
                <a href="/pair" className=" text-black">
                  Font Pair
                </a>
              </p>

              <p className="mb-4">
                <a href="/recommend" className=" text-black">
                  recommendations
                </a>
              </p>
              <p className="mb-4">
